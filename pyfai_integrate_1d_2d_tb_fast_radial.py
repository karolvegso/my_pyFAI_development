...
path_to_images = "d:/programs_work/Python/SimonMicky/Karol_learning_process/Simons_sterss_analysis_soft/Battery8/"
# specify root name of single image
image_root_name = "battery8"
...
path_to_calib = "D:/programs_work/Python/SimonMicky/Karol_learning_process/Simons_sterss_analysis_soft/some_calib_poni_file/lab6_pokus_karol_pyfai_end_02.poni"
...
path_to_mask = "D:/programs_work/Python/SimonMicky/Karol_learning_process/Simons_sterss_analysis_soft/some_calib_poni_file/lab6_pokus_karol_pyfai_end_02.edf"
...
path_to_output_folder = "d:/programs_work/Python/SimonMicky/Karol_learning_process/Simons_sterss_analysis_soft/output_folder_battery8/"
...
radial_range_selector = [4.55 , 59.25]
...
azimuth_range_selector  = [-180.0 , 180.0]
...
radial_range_selector_2D = [0.455 , 5.925]
...
##    print(radial_cut_name)
    ...
    path_to_1D_integs_numpy_arrays_intensity = path_to_output_folder_1D_integs_numpy_arrays_intensity + image_root_name + ".npy"
    path_to_1D_integs_numpy_arrays_q_coord = path_to_output_folder_1D_integs_numpy_arrays_q_coord + image_root_name + ".npy"
    path_to_1D_integs_numpy_arrays_tth_coord = path_to_output_folder_1D_integs_numpy_arrays_tth_coord + image_root_name + ".npy"
    path_to_1D_integs_numpy_arrays_sigma = path_to_output_folder_1D_integs_numpy_arrays_sigma + image_root_name + ".npy"
    path_to_1D_integs_numpy_arrays_intensity_txt = path_to_output_folder_1D_integs_numpy_arrays_intensity_txt + image_root_name + ".txt"
    path_to_1D_integs_numpy_arrays_q_coord_txt = path_to_output_folder_1D_integs_numpy_arrays_q_coord_txt + image_root_name + ".txt"
    path_to_1D_integs_numpy_arrays_tth_coord_txt = path_to_output_folder_1D_integs_numpy_arrays_tth_coord_txt + image_root_name + ".txt"
    path_to_1D_integs_numpy_arrays_sigma_txt = path_to_output_folder_1D_integs_numpy_arrays_sigma_txt + image_root_name + ".txt"
