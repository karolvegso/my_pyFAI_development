...
# import numpy
import numpy as np
# path to 2D integration images in numpy format
path_to_2D_integs = "d:/programs_work/Python/pyfai_integrate_test/test_data_from_poongodi/10-1-2024/output_folder_08/2D_integrations_numpy_arrays_intensity/"
# path to radial coordinates in numpy format
path_to_rad_coord = "d:/programs_work/Python/pyfai_integrate_test/test_data_from_poongodi/10-1-2024/output_folder_08/2D_integrations_numpy_arrays_radial_coord/live_00023.npy"
# path to azimuthal coordinates in numpy format
path_to_azimuth_coord = "d:/programs_work/Python/pyfai_integrate_test/test_data_from_poongodi/10-1-2024/output_folder_08/2D_integrations_numpy_arrays_azimut_coord/live_00023.npy"
# path to folder to save output
path_to_output_folder = "d:/programs_work/Python/pyfai_integrate_test/test_data_from_poongodi/10-1-2024/output_folder_09_azimuth/"
...
# output file name as tetxt file
...
rad_coord = np.load(path_to_rad_coord)
print(rad_coord)
# number of radial points
no_rad_points = rad_coord.shape[0]
print(no_rad_points)
# load numpy array with azimuthal coordinates
azimuth_coord = np.load(path_to_azimuth_coord)
print(azimuth_coord)
...
for index_0 in range(number_of_azimuth_cuts):
    ...
    name_2D_integ_image = root_name + separator + number_current_str + ".npy"
    ...
    image_numpy = np.load(path_to_2D_integ_image)
